  ...
  return (
    ...
    >
      <body className="min-h-full flex flex-col">
        ...
        <Script src="https://cdnjs.cloudflare.com/ajax/libs/jspdf-autotable/3.5.23/jspdf.plugin.autotable.min.js" strategy="beforeInteractive" />
        ...
        <Script src="https://cdn.jsdelivr.net/npm/chart.js@3.9.1/dist/chart.min.js" strategy="beforeInteractive" />
        <Script src="https://cdn.jsdelivr.net/npm/chartjs-adapter-moment@1.0.1/dist/chartjs-adapter-moment.min.js" strategy="beforeInteractive" />
      </body>
    </html>
  );
}
